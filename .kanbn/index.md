...
- [implement-touch-based-drag-drop](tasks/implement-touch-based-drag-drop.md)
- [spec-out-reservation-system](tasks/spec-out-reservation-system.md)
- [make-homepage-view-when-not-logged-in](tasks/make-homepage-view-when-not-logged-in.md)
- [refine-add-item-flow-for-a-wishlist](tasks/refine-add-item-flow-for-a-wishlist.md)
- [spec-out-shopping-list](tasks/spec-out-shopping-list.md)
- [add-ability-to-merge-items-into-bundles](tasks/add-ability-to-merge-items-into-bundles.md)
